...
export default function EMICalculator() {
  ...
  const COLORS = ["#029fae", "#f0f2f3"]; // Using your specified colors
  const formatTooltip = (value) => `₹${value.toLocaleString('en-IN')}`;

  return (
    <div className="min-h-screen bg-[#f0f2f3] px-34 p-4 w-full">
      <div className="bg-white shadow-xl rounded-3xl p-8 w-full overflow-hidden transition-all duration-300 hover:shadow-2xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-6 text-transparent bg-clip-text bg-gradient-to-r from-[#029fae] to-cyan-600">
          EMI Calculator
        </h1>
        ...
        <div className="grid grid-cols-1 mt-10 lg:grid-cols-2 gap-8 w-full">
          {/* Input Section */}
          <div className="space-y-6 w-full">
            <div className=" p-6 rounded-2xl border border-gray-200 w-full">
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full p-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#029fae] focus:border-transparent transition"
                />
              </div>
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-[#029fae] hover:bg-[#028a97] text-white py-3 rounded-xl font-semibold transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
                >
                  Calculate EMI
                </button>
                <button
            ...
            {emi && (
              <div className={`bg-white p-6 rounded-2xl border border-gray-200 shadow-md transition-opacity duration-500 w-full ${isCalculated ? 'opacity-100' : 'opacity-0'}`}>
                <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">Loan Summary</h2>
          ...
          <div className="flex flex-col items-center justify-center w-full">
            {chartData.length > 0 ? (
              <div className={`w-full transition-opacity duration-700 ${isCalculated ? 'opacity-100' : 'opacity-0'}`}>
                <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">Payment Breakdown</h2>
              ...
              <div className="flex flex-col items-center justify-center h-80 w-full bg-gradient-to-br from-[#f0f2f3] to-cyan-50 rounded-2xl border-2 border-dashed border-gray-300 p-8 text-center">
                <svg className="w-16 h-16 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                </svg>
                <p className="text-gray-500 font-medium">Enter loan details and calculate to see visualization</p>
              </div>
            )}
          </div>
        </div>
